...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Transactions", LineAwesomeIcon.BOLD_SOLID.create(), TransactionsView.class), //

                new MenuItemInfo("Documents", LineAwesomeIcon.FILE_PDF_SOLID.create(), DocumentsView.class), //
